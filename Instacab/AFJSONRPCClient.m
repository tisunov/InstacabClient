...
NSString * const AFJSONRPCErrorDomain = @"com.brighstripe.networking.json-rpc";
...
- (id)initWithEndpointURL:(NSURL *)URL {
    ...
    self.responseSerializer.acceptableContentTypes = [NSSet setWithObjects:@"application/json-rpc", @"application/jsonrequest", @"application/json", nil];
