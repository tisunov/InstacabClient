...
// FCOfflineQueue
#define COCOAPODS_POD_AVAILABLE_FCOfflineQueue
#define COCOAPODS_VERSION_MAJOR_FCOfflineQueue 0
#define COCOAPODS_VERSION_MINOR_FCOfflineQueue 1
#define COCOAPODS_VERSION_PATCH_FCOfflineQueue 0
